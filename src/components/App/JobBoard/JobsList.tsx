...
//         {MOCK_JOBS.map((job) => (
//           <div key={job.id} onMouseEnter={() => handleMouseEnter(job.id)} onMouseLeave={handleMouseLeave} className="relative">
...
//                   </div>
//                 </div>
//                 <p className="text-base leading-relaxed line-clamp-2">{job.description}</p>
